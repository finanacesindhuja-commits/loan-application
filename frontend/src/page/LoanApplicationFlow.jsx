...
export default function LoanApplicationFlow() {
  ...
  const validateStep3 = () => {
    ...
    if (!loanForm.houseType) e.houseType = "House type required";
    setErrors(e);
    return Object.keys(e).length === 0;
  };
            ...
            <div className="space-y-8 animate-fade-in relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    name="houseType"
                    value={loanForm.houseType}
                    onChange={handleChange}
                    className={`${inputStyle} ${errors.houseType ? "border-rose-400" : ""}`}
                  >
                  ...
                  {errors.houseType && (
                    <p className="text-rose-500 text-[10px] font-bold uppercase tracking-widest mt-2 ml-1">{errors.houseType}</p>
                  )}
                </div>
